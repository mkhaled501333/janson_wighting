...
class Towdirectonscroll extends StatelessWidget {
  ...
  Widget build(BuildContext context) {
    return Consumer<Hivecontroller>(
      builder: (context, myType, child) {
        List<WieghtTecketMOdel> filterd = allrecords.values
            .toList()
                        ...
                        child: Column(
                          children: [
                            Visibility(
                              ...
                              child: Image.network(
                                'http://192.168.1.225:8080/biscool?imageid=${widget.ticket.firstShotpiccam1Adress}',
                                width: 400,
                                height: 400,
                                fit: BoxFit.fill,
                              ),
                        ...
                        child: Column(
                          children: [
                            Visibility(
                              ...
                              child: Image.network(
                                'http://192.168.1.225:8080/biscool?imageid=${widget.ticket.firstShotpiccam2Adress}',
                                width: 400,
                                height: 400,
                                fit: BoxFit.fill,
                              ),
                            ...
                            Visibility(
                              visible: widget.ticket.synced == true &&
                                  widget.ticket.secondShotpiccam1Adress
                                      .isNotEmpty,
                              child: Image.network(
                                'http://192.168.1.225:8080/biscool?imageid=${widget.ticket.secondShotpiccam1Adress}',
                                width: 400,
                                height: 400,
                                fit: BoxFit.fill,
                              ),
                            ...
                            Visibility(
                              visible: widget.ticket.synced == true &&
                                  widget.ticket.secondShotpiccam2Adress
                                      .isNotEmpty,
                              child: Image.network(
                                'http://192.168.1.225:8080/biscool?imageid=${widget.ticket.secondShotpiccam2Adress}',
                                width: 400,
                                height: 400,
                                fit: BoxFit.fill,
                              ),
...
class Dropdowen extends StatelessWidget {
  ...
  Widget build(BuildContext context) {
    return Consumer<Hivecontroller>(
      builder: (context, myType, child) {
        List<String> items = allrecords.values
            .toList()
            .filterDataBetween(myType.pickedDateFrom!, myType.pickedDateTO!)
